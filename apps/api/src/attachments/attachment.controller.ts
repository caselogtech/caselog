...
import type { CreateUploadSessionResponse, OrganizationAccessPrincipal } from '@caselog/schemas';
...
import { CreateUploadSessionParamsDto, CreateUploadSessionRequestDto } from './attachment.dto';
