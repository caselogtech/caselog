...
export interface paths {
    ...
    "/api/v1/projects/{projectSlug}/environments/{environmentId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface operations {
    ...
    EnvironmentController_update: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateEnvironmentRequestDto"];
            };
        };
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UpdateEnvironmentResponseDto"];
                };
            };
            /** @description API error */
            default: {
